...
const PRIVATE_KEY_PATTERN =
  /(^|_)(DJANGO_SECRET_KEY|DATABASE_URL|REDIS_URL|CELERY_(?:BROKER_URL|RESULT_BACKEND)|AWS_(?:ACCESS_KEY_ID|SECRET_ACCESS_KEY|SESSION_TOKEN)|S3_(?:ACCESS_KEY|SECRET_KEY)|PASSWORD|PASSWD|TOKEN|AUTHORIZATION|SECRET|CREDENTIALS?|CLIENT_SECRET|(?:API|ACCESS|PRIVATE|SIGNING|ENCRYPTION|SECRET)_KEY)($|_)/i;
