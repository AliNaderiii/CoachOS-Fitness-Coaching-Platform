...
| **US-I18N-002** | Persian Search Normalization | `SCR-COACH-08` | `SCR-COACH-06` | `UF-COACH-01` | `docs/ux/WIREFRAMES.md` §3 | `SearchInput`, `Badge`, `Card` | Perso-Arabic script keyboard-variant normalization for Persian search | Real-time live region result count | `exercise.search` | Phase 06 |
